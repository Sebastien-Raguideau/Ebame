...
make sure to launch your VM with -X option, so we can visualize assembly graphs with Bandage.
...
Let's have a look at hifiasm-meta first.
...
We can know if a contig is circular by looking at the contig headers in the fasta files.
