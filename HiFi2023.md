...
Some of these smaller contigs are likely to be plasmids. Let use a machine learning [approach](https://github.com/apcamargo/genomad) to verify this.
...
<details><summary>Let's run genomad (you can use option --sensitivity 1.0 to speed-up prediction, only for the tutorial):</summary>
<p>
