...
We are going to run dRep in a fast fashion, first disable quality check with option --ignoreGenomeQuality (we'll do it after dereplication), and select the "fastANI" method for comparing the circular contigs:
