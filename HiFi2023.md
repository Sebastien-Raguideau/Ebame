...
In this tutorial, we are going to run hifiasm-meta and metaMDBG separatly, then use a method to merge their results without duplicates.
...
Let's use Bandage to compare the Human and Zymo asszemblies.
```bash
